...
namespace Dotdigitalgroup\PageBuilder\Plugin;

use Dotdigitalgroup\Email\Model\Connector\Module;

class ModulePlugin
{
    public const MODULE_NAME = 'Dotdigitalgroup_PageBuilder';
    public const MODULE_DESCRIPTION = 'Dotdigital Page Builder for Magento 2';
